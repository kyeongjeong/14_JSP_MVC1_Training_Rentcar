                    ...
                    <nav class="header__menu">
                        <ul>
                        	...
                        	%>
		                            ...
		                            <li class="active"><a href="adminReservationList.jsp">예약관리(구현하세요)</a></li>
                ...
                <div class="col-lg-12">
                    <div class="shop__cart__table">
                        <table>
                            ...
                            <tbody>
                            	<% 
                            		ArrayList<HashMap<String,Object>> reservationMapList = RentcarDAO.getInstance().getReservationList();
                            		for (HashMap<String , Object> reservationMap : reservationMapList) {
                            	%>
                            			<tr>
                            				<td class="cart__product__item"><input type="checkbox"></td>
                            				<td class="cart__product__item"><%=reservationMap.get("memberId") %></td>
		                                    ...
		                                    <td class="cart__product__item"><%=reservationMap.get("reserveDt") %></td>
